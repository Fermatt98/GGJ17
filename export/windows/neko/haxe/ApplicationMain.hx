...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "ggj17", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "ggj17";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ggj17", null, { width: 640, height: 480 });
