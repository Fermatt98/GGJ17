...
class Level2 extends FlxState
{
	...
	override public function create():Void
	{
		...
		Reg.cantMulti = 0;
		Reg.cantCono = 0;
		Reg.parlante = new Parlante(100, FlxG.height/2, 0);
		Reg.meta = new Meta(1000, FlxG.height/2);
		Reg.pared = new Array<Pared>();
		Reg.pared.push(new Pared(0, FlxG.height / 4, FlxG.width, 128, true));
		Reg.pared.push(new Pared(0, FlxG.height - FlxG.height / 4, FlxG.width, 128, true));
		Reg.interfaz = new Interfaz();
		//Reg.herramienta1 = new Herramienta1(300, 200);
