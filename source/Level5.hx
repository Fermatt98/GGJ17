...
class Level5 extends FlxState
{
	...
	override public function create():Void
	{
		...
		Reg.cantCono = 4;
		Reg.cantMulti = 0;
		Reg.parlante = new Parlante(100, 700, -90);
		Reg.meta = new Meta(1200, 100);
		Reg.pared = new Array<Pared>();
		Reg.pared.push(new Pared(FlxG.width / 3, FlxG.height / 2, 128, FlxG.height / 2,false));
		Reg.pared.push(new Pared(FlxG.width / 3*2, 0, 128, FlxG.height / 2,false));
