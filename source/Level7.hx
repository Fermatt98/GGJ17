...
class Level7 extends FlxState
{
	...
	override public function create():Void
	{
		...
		Reg.cantCono = 3;
		Reg.cantMulti = 0;
		Reg.parlante = new Parlante(FlxG.width-150, 50, 180);
		Reg.meta = new Meta(50, FlxG.height-150);
		Reg.pared = new Array<Pared>();
		Reg.pared.push(new Pared(FlxG.width-FlxG.width/2, FlxG.height / 3-100, FlxG.width, 128,true));
		Reg.pared.push(new Pared(0, FlxG.height-FlxG.height/3-100, FlxG.width/3, 128,true));
